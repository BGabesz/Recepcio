$(function () {
  ...
  const oltozofoglalasok = new OltozoFoglalasok(OltozofoglalasokTomb);
  ...
  function keresés(tomb) {
    ...
    if(tomb.length===0){
      ...
      $(".keresettSzekreny").html("Szekrény tipusa: "+tomb[0].ures_e+" " +tomb[0].tipusa);
      $(".jobbTablazatSzekreny").html("Szekrény tipusa: "+tomb[0].ures_e+" " +tomb[0].tipusa);
